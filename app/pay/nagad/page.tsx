...
export default function PayNagadPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-lg px-4 py-16 text-flowpm-body">
      <h1 className="font-heading text-2xl font-semibold text-flowpm-dark">Pay with Nagad — {label}</h1>
      <p className="mt-3 text-sm text-flowpm-muted">
        Online checkout for this workspace is not connected yet. To finish your upgrade, pay the subscription amount
        via Nagad, then contact your workspace owner with the transaction ID so they can confirm your plan.
      </p>
      ...
      <p className="mt-6 text-sm text-flowpm-muted">
        When your team adds a Nagad payment link in hosting settings, the “Pay with Nagad” button will open checkout
        automatically.
      </p>
